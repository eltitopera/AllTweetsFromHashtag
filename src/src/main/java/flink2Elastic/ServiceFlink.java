...
public class ServiceFlink implements Serializable {
    ...
    private static String ZOO_HOST = "zookeeper:2181";


    public ServiceFlink(){}


    public void execute_process() throws Exception {
        ...
        config.put("cluster.name", "master");
        ...
        env.execute("save tweet in elastic");

    }



    private Properties getConfigurationConsumer(){
        Properties props = new Properties();
        props.put("bootstrap.servers", KAFKA_HOST);
        props.put("zookeeper.connect", ZOO_HOST);
